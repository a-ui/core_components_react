...
export default {
  ...
  args: {
    logoHref: '/',
    logoSrc: 'https://cdn.antwerpen.be/core_branding_scss/7.2.0/assets/images/a-logo.svg',
  ...
  argTypes: {
    ...
    logoSrc: {
      ...
      table: {
        type: { summary: 'string' },
        defaultValue: { summary: 'https://cdn.antwerpen.be/core_branding_scss/7.2.0/assets/images/a-logo.svg' }
      },
