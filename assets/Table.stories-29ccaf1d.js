var P=Object.defineProperty;var f=(n,h)=>P(n,"name",{value:h,configurable:!0});import{c as y}from"./dom.utils-1db2b487.js";import{a as S,b as R}from"./settings-7cdc5a0c.js";import{w as A}from"./render.utils-acac0ad4.js";import{C as E}from"./Checkbox-9df01b90.js";import{j as a,a as v}from"./jsx-runtime-bb315772.js";import{B as O}from"./Button-3ba6d1a5.js";import{u as W}from"./custom.hooks-25de1769.js";import{Q as M}from"./stories.settings-7ac24d87.js";import"./index-d23035ce.js";import"./es.object.get-own-property-descriptor-89e834e9.js";import"./layout.settings-9902fce9.js";import"./Avatar-82f04204.js";import"./Icon-884564ea.js";import"./Spinner-46a860cd.js";import"./log.utils-f56af116.js";function z({columns:n,selectable:h,selected:p=[],rows:r=[],onSelectAll:d,sort:s,small:g,sortDirection:b,tableId:m,onSortClick:c,actions:t}){var o;const i=p.length&&p.sort().join(",")===r.map(e=>e.id).sort().join(",");return a("thead",{children:v("tr",{children:[h?a("th",{children:a(E,{name:`aui-table-checkbox-${m}-all`,id:`aui-table-checkbox-${m}-all`,checked:!!i,indeterminate:!!p.length&&!i,onChange:d,label:"selecteren",showLabel:!1})}):null,n.map(e=>{const l=y({"u-text-right":!!e.alignRight,"is-collapsed":!!e.sortable,"is-condensed":!!g}),u=s===(e==null?void 0:e.value)&&b===S,w=s===(e==null?void 0:e.value)&&b===R,T=y({"a-table__sort-button":!0,"a-table__sort-button--unsorted":s!==(e==null?void 0:e.value),"a-table__sort-button--sorted-asc":u,"a-table__sort-button--sorted-desc":w});return a("th",{className:l,...e.sortable&&(u||w)&&{"aria-sort":u?S:R},...e.sortable&&{"aria-live":"polite"},children:A(e==null?void 0:e.label,a("button",{onClick:V=>c&&c(e.value),className:T}),!!(e!=null&&e.sortable))},e==null?void 0:e.value)}),(o=t==null?void 0:t.buttons)!=null&&o.length?a("th",{children:t==null?void 0:t.label}):null]})})}f(z,"TableHeader");function $({actions:n,columns:h,small:p,tableId:r,selectable:d,onSelect:s,selected:g=[],rows:b}){const m=y({"is-clickable":!!d}),c=f((t,i)=>{var e,l;const o=t.target;return o!=null&&o.classList.contains("a-button")||(l=(e=o.parentElement)==null?void 0:e.parentElement)!=null&&l.classList.contains("a-button")?!1:(t.preventDefault(),t.stopPropagation(),d&&s&&s(i.id))},"selectRow");return a("tbody",{children:b.map(t=>{var i,o;return v("tr",{onClick:e=>c(e,t),className:m,children:[d?a("td",{children:a(E,{name:`aui-table-checkbox-${r}-${t.id}`,id:`aui-table-checkbox-row-${r}-${t.id}`,checked:(g||[]).includes(t.id),onChange:e=>c(e,t),label:t.checkboxLabel,showLabel:!1})}):null,h.map(e=>{const l=y({"u-text-right":!!e.alignRight,"u-text-bold":e.dataType==="primary",small:e.dataType==="secondary","is-condensed":!!p});return a("td",{className:l,children:e.transformFunction?e.transformFunction(t[e==null?void 0:e.value]||null):t[e==null?void 0:e.value]||null},e==null?void 0:e.value)}),A(((i=n==null?void 0:n.buttons)==null?void 0:i.map(e=>a(O,{onClick:l=>(e==null?void 0:e.onActionClick)&&(e==null?void 0:e.onActionClick(l,t.id)),...e,id:`aui-table-action-${r}-${e==null?void 0:e.id}-${t.id}`,size:(e==null?void 0:e.size)||"small",children:e==null?void 0:e.label},`aui-table-action-${r}-${e==null?void 0:e.id}-${t.id}`)))||null,a("td",{}),!!((o=n==null?void 0:n.buttons)!=null&&o.length))]},t==null?void 0:t.id)})})}f($,"TableBody");function k({id:n,sort:h,sortDirection:p,rows:r,columns:d,qa:s,striped:g,small:b,open:m,selectable:c,selected:t,onSelect:i,onSelectAll:o,onSortClick:e,actions:l,responsive:u,fixedColumnRight:w,fixedColumnLeft:T}){const[V,_,L,N]=W(),j=y({"a-table":!0,"a-table--striped":!!g,"a-table--open":!!m}),x=y({"a-table-responsive-wrapper":!!u,"has-shadow-left":!!u&&!L,"has-shadow-right":!!u&&!N,"has-first-column-fixed":!!T,"has-last-column-fixed":!!w}),C=v("table",{id:n,className:j,"data-qa":s,children:[a(z,{tableId:n,small:b,selectable:c,selected:t,columns:d,sort:h,rows:r,onSortClick:e,sortDirection:p,onSelectAll:o,actions:l}),a($,{tableId:n,small:b,selectable:c,selected:t,columns:d,rows:r,onSelect:i,actions:l})]});return u?a("div",{className:x,"data-qa":s,children:a("div",{ref:V,onScroll:_,className:"a-table-scrollable-wrapper",children:C})}):C}f(k,"Table");k.defaultProps={id:"aui-table",columns:[],rows:[],responsive:!0};const q=[{label:"Snack",value:"snack",sortable:!0,dataType:"primary"},{label:"Description",value:"description",sortable:!0,dataType:"secondary"},{label:"Stock",value:"stock",alignRight:!0,dataType:"secondary"},{label:"Price",value:"price",alignRight:!0}],F=[{id:"0",snack:"Ice cream",description:"Tasty, frozen treat for a hot day",stock:160,price:"€2,49"},{id:"1",snack:"Chips",description:"Salty, crunchy goodness",stock:48,price:"€1,99"},{id:"2",snack:"Candy bar",description:"Chewy and quite nutty",stock:240,price:"€1,49"}],re={title:"React/Atoms/Table",component:k,parameters:{storySource:{source:`import Table from './Table';
