var T=Object.defineProperty;var r=(t,e)=>T(t,"name",{value:e,configurable:!0});import{R as B,r as A}from"./index-d23035ce.js";import{c as I}from"./dom.utils-1db2b487.js";import{B as W}from"./Button-16bbd0a8.js";import{I as j}from"./Icon-597278d2.js";import{a as f,j as a}from"./jsx-runtime-bb315772.js";import{Q as C}from"./stories.settings-7ac24d87.js";import"./es.object.get-own-property-descriptor-89e834e9.js";import"./layout.settings-9902fce9.js";import"./render.utils-a6f7fcbc.js";import"./Avatar-c0311054.js";import"./settings-4d2c475c.js";import"./Spinner-2995a70f.js";import"./log.utils-f56af116.js";const P=1048576;function S(t,e){var l,n;return!e||e==="*"||e===t.type||(e==null?void 0:e.includes("*"))&&!!((l=e==null?void 0:e.split("/"))!=null&&l[0])&&t.type.startsWith((n=e==null?void 0:e.split("/"))==null?void 0:n[0])}r(S,"hasValidFormat");function z(t,e){return!e||t.size<=e*P}r(z,"hasValidSize");function w(t,e,l){return t.map(n=>({validFormat:S(n,e),validSize:z(n,l)}))}r(w,"areFilesValid");function q({file:t,acceptedFormat:e,maxSize:l,onDelete:n,formatErrorLabel:d,deleteAriaLabel:s,sizeErrorLabel:y}){const i=S(t,e),p=z(t,l);return f("li",{children:[a(j,{name:i&&p?"common-file-empty":"alert-triangle"}),a("span",{className:"m-upload__filename",children:t.name}),!i&&a("span",{className:"m-upload__error",children:d}),!p&&a("span",{className:"m-upload__error",children:y}),n&&a("div",{className:"m-upload__delete",children:a(W,{ariaLabel:s,addOn:{type:"icon",iconProps:{name:"remove"}},emphasis:"low",theme:"danger",size:"small",onClick:()=>n(t)})})]},t.name)}r(q,"UploadFile");function g({acceptedFormat:t,deleteAriaLabel:e,disabled:l,files:n,formatErrorLabel:d,id:s,label:y,maxSize:i,maxSizeLabel:p,multiple:V,onChange:c,onDelete:b,sizeErrorLabel:O,qa:L}){const h=B.useRef(null),D=r(o=>{b&&b(n==null?void 0:n.filter(u=>(u==null?void 0:u.name)!==o.name)),h.current&&(h.current.value="")},"handleDelete"),R=r(o=>{var u,x,v,_,M;if(V){const m=(u=o.target)!=null&&u.files?[...n,...Array.from(o.target.files)].filter((k,E,N)=>N.findIndex(U=>U.name===k.name)===E):[];c&&c(m,w(m,t,i))}else{const m=(v=(x=o.target)==null?void 0:x.files)!=null&&v[0]?[(M=(_=o.target)==null?void 0:_.files)==null?void 0:M[0]]:[];c&&c(m,w(m,t,i))}},"handleChange");return f("div",{className:I({"m-upload":!0,"is-disabled":!!l}),"data-qa":L,children:[a("div",{className:"m-upload__inner",children:f("div",{className:"m-upload__dropzone",children:[a("input",{ref:h,id:s,type:"file",multiple:V,onChange:R,accept:t,className:"m-upload__input",disabled:l,"aria-describedby":`${s}-description`}),a("div",{className:"m-upload__content",children:a("label",{htmlFor:s,className:"m-upload__message u-margin-bottom",children:y})})]})}),i&&f("small",{id:`${s}-description`,className:"m-upload__description",children:[p," ",i,"MB"]}),a("ul",{className:"m-upload__files",children:n==null?void 0:n.map(o=>a(q,{file:o,deleteAriaLabel:e,formatErrorLabel:d,sizeErrorLabel:O,onDelete:b&&D,maxSize:i,acceptedFormat:t},o==null?void 0:o.name))})]})}r(g,"Upload");g.defaultProps={label:"Sleep een bestand hier of klik om te bladeren",maxSize:10,multiple:!0,disabled:!1,acceptedFormat:"*",files:[],maxSizeLabel:"Maximale bestandsgrootte:",formatErrorLabel:"Dit bestandsformaat is niet toegestaan.",sizeErrorLabel:"Maximale bestandsgrootte overschreden.",deleteAriaLabel:"Verwijder bestand"};const oe={title:"React/Molecules/Upload",component:g,parameters:{storySource:{source:`import Upload from './Upload';
...
//# sourceMappingURL=Upload.stories-bfec1906.js.map
