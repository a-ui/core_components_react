import { Button, Calendar, Datepicker, DateRangePicker } from '@a-ui/react';
...
export function DatepickerExamples() {
  ...
  const [dateRange, setDateRange] = useState([
    new Date('2023-02-22').toISOString(),
    new Date('2023-02-28').toISOString()
  ]);
  ...
  return (
    <>
      <div className="u-margin-xl" style={{ width: '600px' }}>
        <h2>Calendar</h2>
        <div className="u-margin">
          <p className="u-margin-top">Uncontrolled</p>
          <Calendar
            locale={mn}
            highlightDates={[new Date('2024-01-01').toISOString(), new Date('2030-01-01').toISOString()]}
          />
